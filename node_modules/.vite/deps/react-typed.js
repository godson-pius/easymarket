...
var require_react_typed = __commonJS({
  "node_modules/react-typed/dist/react-typed.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module == "object" ? module.exports = t(require_react()) : typeof define == "function" && define.amd ? define(["react"], t) : typeof exports == "object" ? exports["react-typed"] = t(require_react()) : e["react-typed"] = t(e.React);
    }(exports, function(e) {
      return function(e2) {
        var t = {};
        function n(r) {
          ...
          return function(e3) {
            ...
            var o = n2(1), s = n2(3), i = function() {
              ...
              return r2(e4, [{ key: "toggle", value: function() {
                ...
                this.typingComplete = false, this.shuffleStringsIfNeeded(this), this.insertCursor(), this.bindInputFocusEvents && this.bindFocusEvents(), this.timeout = setTimeout(function() {
                  e5.currentElContent && e5.currentElContent.length !== 0 ? e5.backspace(e5.currentElContent, e5.currentElContent.length) : e5.typewrite(e5.strings[e5.sequence[e5.arrayPos]], e5.strPos);
                }, this.startDelay);
                ...
                t3 === 0 && (this.toggleBlinking(false), this.options.preStringTyped(this.arrayPos, this)), t3 += n3;
                ...
                this.attr ? this.el.setAttribute(this.attr, e5) : this.isInput ? this.el.value = e5 : this.contentType === "html" ? this.el.innerHTML = e5 : this.el.textContent = e5;
                ...
                this.isInput && (this.el.addEventListener("focus", function(t3) {
                  ...
                  e5.el.value && e5.el.value.length !== 0 || e5.start();
                }));
            ...
            var s, i = n2(2), a = (s = i) && s.__esModule ? s : { default: s }, u = function() {
              ...
              return o(e4, [{ key: "load", value: function(e5, t3, n3) {
                ...
                return e5.attr ? e5.el.getAttribute(e5.attr) : e5.isInput ? e5.el.value : e5.contentType === "html" ? e5.el.innerHTML : e5.el.textContent;
                ...
                if (e5.autoInsertCss && (e5.showCursor || e5.fadeOut) && !document.querySelector("[data-typed-js-css]")) {
                  ...
                  var n3 = "";
                  e5.showCursor && (n3 += "\n        .typed-cursor{\n          opacity: 1;\n        }\n        .typed-cursor.typed-cursor--blink{\n          animation: typedjsBlink 0.7s infinite;\n          -webkit-animation: typedjsBlink 0.7s infinite;\n                  animation: typedjsBlink 0.7s infinite;\n        }\n        @keyframes typedjsBlink{\n          50% { opacity: 0.0; }\n        }\n        @-webkit-keyframes typedjsBlink{\n          0% { opacity: 1; }\n          50% { opacity: 0.0; }\n          100% { opacity: 1; }\n        }\n      "), e5.fadeOut && (n3 += "\n        .typed-fade-out{\n          opacity: 0;\n          transition: opacity .25s;\n        }\n        .typed-cursor.typed-cursor--blink.typed-fade-out{\n          -webkit-animation: 0;\n          animation: 0;\n        }\n      "), t3.length !== 0 && (t3.innerHTML = n3, document.body.appendChild(t3));
                }
              } }]), e4;
            }();
            t2.default = u;
        ...
        var h = function(e3) {
          function t2() {
            ...
            for (var l2 = arguments.length, f2 = new Array(l2), d2 = 0; d2 < l2; d2++)
              f2[d2] = arguments[d2];
            return r2 = this, n3 = !(s3 = (e4 = p(t2)).call.apply(e4, [this].concat(f2))) || c(s3) !== "object" && typeof s3 != "function" ? y(r2) : s3, i3 = y(n3), a2 = "rootElement", u2 = o.a.createRef(), a2 in i3 ? Object.defineProperty(i3, a2, { value: u2, enumerable: true, configurable: true, writable: true }) : i3[a2] = u2, n3;
          }
          var n2, s2, i2;
          return function(e4, t3) {
            ...
            var e4 = this, t3 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, n3 = this.props, r2 = (n3.style, n3.typedRef, n3.stopped, n3.className, l(n3, ["style", "typedRef", "stopped", "className"]));
        ...
        t.typeOf = S, t.AsyncMode = f, t.ConcurrentMode = p, t.ContextConsumer = l, t.ContextProvider = c, t.Element = o, t.ForwardRef = y, t.Fragment = i, t.Lazy = b, t.Memo = m, t.Portal = s, t.Profiler = u, t.StrictMode = a, t.Suspense = d, t.isValidElementType = function(e3) {
          return typeof e3 == "string" || typeof e3 == "function" || e3 === i || e3 === p || e3 === u || e3 === a || e3 === d || e3 === h || typeof e3 == "object" && e3 !== null && (e3.$$typeof === b || e3.$$typeof === m || e3.$$typeof === c || e3.$$typeof === l || e3.$$typeof === y || e3.$$typeof === v || e3.$$typeof === g);
          ...
          return typeof e3 == "object" && e3 !== null && e3.$$typeof === o;
        ...
        (function() {
          ...
          var v = function(e4) {
            ...
            typeof console != "undefined" && console.warn(s2);
            try {
              throw new Error(s2);
            } catch (e5) {
            }
          ...
          t.typeOf = S, t.AsyncMode = O, t.ConcurrentMode = w, t.ContextConsumer = k, t.ContextProvider = P, t.Element = C, t.ForwardRef = j, t.Fragment = T, t.Lazy = x, t.Memo = E, t.Portal = I, t.Profiler = _, t.StrictMode = R, t.Suspense = $, t.isValidElementType = function(e4) {
            return typeof e4 == "string" || typeof e4 == "function" || e4 === o || e4 === l || e4 === i || e4 === s || e4 === p || e4 === y || typeof e4 == "object" && e4 !== null && (e4.$$typeof === h || e4.$$typeof === d || e4.$$typeof === a || e4.$$typeof === u || e4.$$typeof === f || e4.$$typeof === m || e4.$$typeof === b);
            ...
            return typeof e4 == "object" && e4 !== null && e4.$$typeof === n2;
        ...
        u = function(e3) {
          var t2 = "Warning: " + e3;
          typeof console != "undefined" && console.error(t2);
          try {
            throw new Error(t2);
          } catch (e4) {
          }
        }, e2.exports = function(e3, t2) {
          var n2 = typeof Symbol == "function" && Symbol.iterator, l = "@@iterator";
          var f = "<<anonymous>>", p = { array: m("array"), bool: m("boolean"), func: m("function"), number: m("number"), object: m("object"), string: m("string"), symbol: m("symbol"), any: h(c), arrayOf: function(e4) {
            ...
            return h(function(t3, n3, r2, o2, s2) {
              ...
              var u2 = JSON.stringify(e4, function(e5, t4) {
                return g(t4) === "symbol" ? String(t4) : t4;
              });
            ...
            return h(function(t4, n4, r2, o2, i2) {
              for (var a2 = 0; a2 < e4.length; a2++) {
                if ((0, e4[a2])(t4, n4, r2, o2, i2, s) == null)
                  return null;
              }
          ...
          function y(e4, t3) {
            return e4 === t3 ? e4 !== 0 || 1 / e4 == 1 / t3 : e4 != e4 && t3 != t3;
          }
          function d(e4) {
          ...
          function h(e4) {
            ...
            function o2(o3, i3, a2, c2, l2, p2, y2) {
              ...
              return i3[a2] == null ? o3 ? i3[a2] === null ? new d("The " + l2 + " `" + p2 + "` is marked as required in `" + c2 + "`, but its value is `null`.") : new d("The " + l2 + " `" + p2 + "` is marked as required in `" + c2 + "`, but its value is `undefined`.") : null : e4(i3, a2, c2, l2, p2);
            }
          ...
          function v(e4) {
            ...
            return Array.isArray(e4) ? "array" : e4 instanceof RegExp ? "object" : function(e5, t4) {
              return e5 === "symbol" || !!t4 && (t4["@@toStringTag"] === "Symbol" || typeof Symbol == "function" && t4 instanceof Symbol);
            }(t3, e4) ? "symbol" : t3;
          }
          function g(e4) {
            if (e4 == null)
        ...
        e2.exports = function() {
          try {
            ...
            if (Object.getOwnPropertyNames(t2).map(function(e4) {
              return t2[e4];
            }).join("") !== "0123456789")
              return false;
            var r2 = {};
          ...
          for (var c in e3)
            if (i(e3, c)) {
              ...
              if (!l || l instanceof Error || r((a2 || "React class") + ": type specification of " + n2 + " `" + c + "` is invalid; the type checker function must return `null` or an `Error` but returned a " + typeof l + ". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."), l instanceof Error && !(l.message in s)) {
                s[l.message] = true;
                var p = u ? u() : "";
                r("Failed " + n2 + " type: " + l.message + (p != null ? p : ""));
              }
            }
        }
        r = function(e3) {
