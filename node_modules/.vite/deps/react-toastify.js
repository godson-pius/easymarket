...
var I = { info: function(t2) {
  ...
  return import_react.default.createElement(_, __spreadValues({}, t2), import_react.default.createElement("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
}, error: function(t2) {
...
function O(e2) {
  ...
  function N2(e3, n2) {
    let _a = n2, { delay: s2, staleId: r2 } = _a, i2 = __objRest(_a, ["delay", "staleId"]);
    if (!y(e3) || function(e4) {
...
var k = (t2) => {
  ...
  let H2 = null;
  return r2 === false || (H2 = m(r2) ? r2(z2) : import_react.default.isValidElement(r2) ? import_react.default.cloneElement(r2, z2) : x(z2)), import_react.default.createElement(g2, { isIn: B2, done: k2, position: y2, preventExitTransition: o2, nodeRef: s2 }, import_react.default.createElement("div", __spreadProps(__spreadValues({ id: N2, onClick: u2, className: F2 }, a2), { style: T2, ref: s2 }), import_react.default.createElement("div", __spreadProps(__spreadValues({}, B2 && { role: I2 }), { className: m(v2) ? v2({ type: d2 }) : clsx_m_default("Toastify__toast-body", v2), style: E2 }), D2 != null && import_react.default.createElement("div", { className: clsx_m_default("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !M2 }) }, D2), import_react.default.createElement("div", null, i2)), H2, (c2 || S2) && import_react.default.createElement(R, __spreadProps(__spreadValues({}, _2 && !S2 ? { key: "pb-" + _2 } : {}), { rtl: L2, theme: w2, delay: c2, isRunning: n2, isIn: B2, closeToast: f2, hide: p2, type: d2, style: C2, className: b2, controlledProgress: S2, progress: O2 }))));
};
...
var A = (0, import_react.forwardRef)((t2, n2) => {
  ...
  return (0, import_react.useEffect)(() => {
    ...
    return import_react.default.createElement("div", { className: p2(t3), style: o3, key: "container-" + t3 }, n3.map((t4, o4) => {
      ...
      return import_react.default.createElement(k, __spreadProps(__spreadValues({}, a3), { isIn: r2(a3.toastId), style: __spreadProps(__spreadValues({}, a3.style), { "--nth": o4 + 1, "--len": n3.length }), key: "toast-" + a3.key }), s2);
    }));
  }));
});
